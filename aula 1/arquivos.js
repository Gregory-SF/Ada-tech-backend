...
// const filePath = path.join(process.cwd(), 'aula \'1\'', 'texto.txt')
// const fileOutPath = path.join(process.cwd(), 'aula \'1\'', 'texto-com-linhas.txt')
const filePath = path.join(process.cwd(), 'aula 1', 'texto.txt')
const fileOutPath = path.join(process.cwd(), 'aula 1', 'texto-com-linhas.txt')
...
fs.readFile(filePath, {}, (erro, dados) => {
    ...
    fs.writeFile(fileOutPath, linhasAjustadas.join('/n'), {}, (erro) => {
        if(erro){
